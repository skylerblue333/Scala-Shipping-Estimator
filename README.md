...
shipping estimator in Scala.

## 🚀 Overview
This repository contains a professional implementation of **Scala Shipping Estimator**. It is designed with clean code principles and focuses on functionality and reliability.
